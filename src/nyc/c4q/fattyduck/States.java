...
public static void main(String[] args) {
        ...
        System.out.println("Which state do you want to get capital information?");
        ...
        if(!getCapitals().containsKey(state)){
            System.out.println("Only a cow would thin that "+state+ " is a state");
        }else{
            System.out.println(getCapitals().get(state));
        }
